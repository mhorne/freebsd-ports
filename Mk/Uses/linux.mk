...
ONLY_FOR_ARCHS_REASON=	Linux compatibility is only available on arm64, amd64, and i386
.endif
...
DISTFILES_aarch64?=	${LIB_DISTNAMES:S/$/${EXTRACT_SUFX_aarch64}/} \
			${BIN_DISTNAMES:S/$/${EXTRACT_SUFX_aarch64}/} \
			${SHARE_DISTNAMES:S/$/${EXTRACT_SUFX_noarch}/}
.endif
